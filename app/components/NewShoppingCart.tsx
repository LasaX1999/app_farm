                ...
                <div className="md:col-span-2 space-y-4">
                    ...
                    <div className="flex gap-4 bg-white px-4 py-6 rounded-md shadow-[0_2px_12px_-3px_rgba(6,81,237,0.3)]">
                        <div className="flex gap-4">
                            ...
                            <div className="flex flex-col gap-4">
                                <div>
                                    <h3 className="text-base font-bold text-gray-800">Stylish Golden Watch</h3>
                    ...
                    <div className="flex gap-4 bg-white px-4 py-6 rounded-md shadow-[0_2px_12px_-3px_rgba(6,81,237,0.3)]">
                        <div className="flex gap-4">
                            ...
                            <div className="flex flex-col gap-4">
                                <div>
                                    <h3 className="text-base font-bold text-gray-800">Stylish Smart Watch</h3>
                                    <p className="text-sm font-semibold text-gray-500 mt-2 flex items-center gap-2">Color: <span className="inline-block w-5 h-5 rounded-md bg-[#e8dcdc]"></span></p>
                                </div>
                    ...
                    <div className="flex gap-4 bg-white px-4 py-6 rounded-md shadow-[0_2px_12px_-3px_rgba(6,81,237,0.3)]">
                        <div className="flex gap-4">
                            ...
                            <div className="flex flex-col gap-4">
                                <div>
                                    <h3 className="text-base font-bold text-gray-800">Round Glass</h3>
                                    <p className="text-sm font-semibold text-gray-500 mt-2 flex items-center gap-2">Color: <span className="inline-block w-5 h-5 rounded-md bg-[#000]"></span></p>
                                </div>
                        ...
                        <div className="ml-auto flex flex-col">
                            ...
                            <h3 className="text-base font-bold text-gray-800 mt-auto">$20.00</h3>
                        </div>
                    </div>
                </div>
