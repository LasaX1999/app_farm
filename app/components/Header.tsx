    ...
    <div className=" border-b-2 border-[#F5F3FF]">
      ...
      <div className="max-w-7xl mx-auto flex justify-between  items-center">
        ...
        <div className="flex items-center relative ">
          ...
          <Link href={'/admin'} className="lg:text-xl text-[18px]  mr-4 relative  w-fit block after:block after:content-[''] after:absolute after:h-[3px] after:bg-black after:w-full after:scale-x-0 after:hover:scale-x-100 after:transition after:duration-300 after:origin-left">Sell </Link>
