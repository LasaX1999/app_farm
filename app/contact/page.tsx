    ...
    return (
      <div className="bg-[conic-gradient(at_top_left,_var(--tw-gradient-stops))] from-indigo-400 via-indigo-200 to-indigo-300 mt-20 mb-10 p-16 rounded-xl shadow-2xl max-w-md mx-auto">
        <div className="flex flex-col items-center  text-center">
          ...
          <Link
            href="/Contact"
            className="inline-block py-3 px-6 bg-[#030303] text-white text-lg font-medium rounded-full shadow-lg transition-transform transform hover:scale-105 hover:bg-gray-200 focus:outline-none focus:ring-4 focus:ring-red-300"
          >
            Go Back
          </Link>
        </div>
          ...
          <div className="mt-12 grid lg:grid-cols-2 shadow-2xl gap-8 lg:gap-20">
            <div className="flex flex-col border shadow-lg border-gray-300 rounded-xl p-6 sm:p-8 lg:p-10 bg-white ">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mt-6 grid">
                  <button
                    type="submit"
                    className="w-full py-4 px-5 inline-flex justify-center items-center text-base rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700"
                  >
                    Send Inquiry
                  </button>
                </div>
            ...
            <div className="divide-y divide-gray-200">
              <div className="flex gap-x-8 py-8">
                <svg
                  className="shrink-0 w-8 h-8 mt-1.5 text-gray-800"
                ...
                <div className="grow">
                  ...
                  >
                    Contact support
                    <svg
                      className="shrink-0 w-4 h-4 ml-1.5 transition-transform transform group-hover:translate-x-1 group-focus:translate-x-1"
                      viewBox="0 0 16 16"
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                    >
