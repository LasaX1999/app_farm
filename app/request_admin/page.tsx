...
function page() {
  ...
  if (state.succeeded) {
    return <div className="bg-blue-100 p-8 ">
  ...
  return (
    <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-6 font-oswald">
    <div className="text-center px-6">
        <h2 className="text-gray-800 text-3xl font-extrabold">Request For Selling</h2>
        ...
        <div className="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
            ...
            <ul className="mt-16 space-y-8">
                ...
                <li className="flex items-center">
                    ...
                    <a href="javascript:void(0)" className="text-white text-sm text-gray-500 ml-4">
                        No 4-DirectX Building,Dambulla
                    </a>
                </li>
            </ul>
        ...
        <div className="grid sm:grid-cols-2 gap-8">
            ...
            >
              ...
              <g clipPath="url(#a)" transform="matrix(1.33 0 0 -1.33 0 682.667)">
                <path
                  ...
                  stroke-miterlimit="10"
                  stroke-width="40"
                  d="m452 444-108-84 56 152-56-152L20 64l412 196L92 92Z"
                  data-original="#000000"
                ></path>
              </g>
            </svg>
          ...
          <div className="sm:col-span-2">
            <button
              ...
              className="text-sm font-medium px-8 py-3 text-white border-2 border-blue-500 bg-blue-500 hover:bg-transparent hover:text-blue-500 active:bg-blue-700 active:text-white outline-none focus:outline-none ease-linear transition-all duration-150"
            >
              Send Message
            </button>
          </div>
