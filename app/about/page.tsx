...
function page() {
  ...
  <a target="_blank" rel="noreferrer" href="https://example.com"
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 248 204" className="h-5 w-5 text-[#1d9bf0]">
  ...
  <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-0 sm:gap-x-4">
    ...
    <a href="#demo"
      className="flex flex-row items-center justify-center gap-x-2 rounded-lg border border-teal-500 px-10 py-3 text-teal-500">Learn
      More →
    </a>
  </div>
</div>
